...
const favoriteItems = [
    { label: 'Core Platform', color: 'bg-indigo-500', path: '/dashboard' },
    { label: 'Mobile App', color: 'bg-emerald-500', path: '/dashboard' },
    { label: 'Design System', color: 'bg-rose-500', path: '/dashboard' },
]
...
const DashboardLayout = () => {
    ...
    return (
      ...
      `}</style>
            ...
            <aside
                className={`
          w-[260px] flex-shrink-0 border-r border-zen-border bg-zen-sidebar flex flex-col h-full
        ...
        `}
            >
                {/* Sidebar Header */}
                <div className="h-16 flex items-center justify-between px-6 border-b border-zen-border">
                    <div className="flex items-center gap-3">
                        <div className="size-8 bg-zen-blue/20 rounded-lg flex items-center justify-center text-zen-blue">
                ...
                <nav className="flex-1 overflow-y-auto py-6 px-3 flex flex-col gap-6 zen-scroll">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        {workspaceItems.map((item) => (
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors group ${isActive
                    ...
                    <div className="mt-auto px-3">
                        <button className="bg-zen-blue hover:bg-blue-600 text-white text-sm font-bold py-1.5 px-4 rounded shadow-lg shadow-blue-900/20 transition-all flex items-center gap-2 w-full justify-center">
                ...
                <div className="p-4 border-t border-zen-border">
                    <div className="flex items-center gap-3 w-full p-2 rounded-lg hover:bg-zen-surface-hl transition-colors group">
                        {avatarUrl ? (
                            <img
                                src={avatarUrl}
                                alt={displayName}
                                className="rounded-full size-8 border border-zen-border object-cover"
                            />
                        ) : (
                            <div className="size-8 rounded-full bg-gradient-to-br from-zen-blue to-indigo-600 flex items-center justify-center text-xs font-bold text-white">

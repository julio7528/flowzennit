...
const Hero = () => {
  ...
  return (
    <Motion.section
      id="sobre"
      className="relative pt-28 pb-20 overflow-hidden scroll-mt-24 bg-[#050914] text-white flex flex-col items-center"
    >
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none overflow-hidden">
        <div className="absolute top-[5%] left-[20%] w-[400px] h-[400px] bg-purple-600/15 rounded-full blur-[140px]" />
        <div className="absolute top-[40%] right-[15%] w-[500px] h-[500px] bg-cyan-600/15 rounded-full blur-[150px]" />
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:32px_32px] [mask-image:radial-gradient(ellipse_70%_70%_at_50%_40%,#000_40%,transparent_100%)]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex flex-col items-center w-full">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 mb-6 backdrop-blur-md shadow-lg"
          >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 leading-tight max-w-4xl"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl text-slate-400 mb-10 max-w-3xl leading-relaxed font-medium"
          >
            <Trans
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-16">
            <Link
              to="/login"
              className="px-8 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg hover:shadow-[0_0_25px_rgba(147,51,234,0.4)] transition-all flex items-center justify-center gap-2 group"
            >
        ...
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-px bg-gradient-to-r from-transparent via-purple-500 to-transparent opacity-50" />
          ...
          <svg viewBox="0 0 1000 450" className="w-full h-auto drop-shadow-2xl overflow-visible">
            ...
            <g transform="translate(60, 225)">
              <text x="0" y="-35" fill="#94a3b8" fontSize="14" fontWeight="bold" letterSpacing="0.1em">
                {t('hero.diagram.demands')}
              </text>
            ...
            <g transform="translate(160, 175)">
              ...
              <text x="75" y="65" textAnchor="middle" fill="#93c5fd" fontSize="11" fontWeight="bold">
                {t('hero.diagram.organization')}
              </text>
            ...
            <g transform="translate(450, 225)">
              ...
              <text x="0" y="-70" textAnchor="middle" fill="#c084fc" fontSize="11" fontWeight="bold">
                {t('hero.diagram.prioritizes')}
              </text>
            </g>
            ...
            <g transform="translate(760, 225)">
              ...
              <text x="0" y="-200" textAnchor="middle" fill="#67e8f9" fontSize="16" fontWeight="black" letterSpacing="0.2em">
                {t('hero.diagram.pdcaCycle')}
              </text>
              ...
              <text x="0" y="-115" textAnchor="middle" fill="#f472b6" fontSize="12" fontWeight="bold" letterSpacing="0.1em">
                MASP
              </text>
